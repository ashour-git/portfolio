...
export function Monitoring({ observability }: { observability: Observability }) {
  return (
    <div className="overflow-hidden rounded-2xl border border-line bg-bg/40">
      ...
      <div className="grid gap-0 md:grid-cols-[1fr_1.2fr]">
        ...
        <div className="bg-black/40 p-5 sm:p-7">
          <p className="mb-4 flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.18em] text-ink-faint">
      ...
      <p className="border-t border-line px-5 py-3 font-mono text-[10px] uppercase tracking-[0.18em] text-ink-faint sm:px-7">
